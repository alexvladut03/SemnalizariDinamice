...
export default function CommandSummaryBillingData() {
  return (
    <div className="border rounded-lg p-4">
      <div className="pb-2 mb-2 border-b border-amber-500 flex items-center relative">
        ...
        <div className="pl-8 text-md font-semibold">Date facturare</div>
        <button className="px-2 bg-amber-500 text-white rounded absolute right-2">
          Modifica
        </button>
      </div>
      <div className="font-medium">Persoana juridica</div>
    </div>
  );
}
